...
namespace Business.Logic
{
    ...
    public class PersonaValidator : AbstractValidator<Persona>
    {
        ...
        {
            RuleFor(x => x.Nombre).NotEmpty().MaximumLength(50).Matches("^[a-zA-ZüéáíóúñÑ ]+$").WithMessage("'Nombre' debe contener solo letras"); // ValidarLetras
            RuleFor(x => x.Apellido).NotEmpty().MaximumLength(50).Matches("^[a-zA-ZüéáíóúñÑ ]+$").WithMessage("'Apellido' debe contener solo letras"); // ValidarLetras
            RuleFor(x => x.Direccion).NotEmpty().MaximumLength(50).Matches("^[a-zA-Z0-9üéáíóúñÑ ]+$").WithMessage("'Dirección' debe contener solo letras y/o números"); // ValidarLetrasNumeros
    ...
    public class PlanValidator : AbstractValidator<Plan>
    {
        ...
        {
            RuleFor(x => x.Descripcion).NotEmpty().MaximumLength(50).Matches("^[a-zA-Z0-9üéáíóúñÑ ]+$").WithMessage("'Descripcion' debe contener solo letras y/o números"); // ValidarLetrasNumeros
        }
    }
    public class MateriaValidator : AbstractValidator<Materia>
    {
        ...
        {
            RuleFor(x => x.Descripcion).NotEmpty().Length(min: 3, max: 20).Matches("^[a-zA-Z0-9üéáíóúñÑ ]+$").WithMessage("'Descripcion' debe contener solo letras y/o números"); // ValidarLetrasNumeros
